...
values
('SO1', 'Habilidad para identificar, formular y resolver problemas complejos de ingeniería aplicando principios de ingeniería, ciencia y matemáticas.'),
('SO2', 'Habilidad para aplicar el diseño de ingeniería para producir soluciones que satisfagan necesidades específicas teniendo en cuenta la salud, la seguridad y el bienestar público, así como los factores globales, culturales, sociales, ambientales y económicos.'),
...
insert into performance_evaluations (evaluation_value)
values
('Insatisfactorio'),
('En Desarrollo'),
('Bueno'),
